      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Serbest Muhasebeci Mali Müşavirler için geliştirilmiş multi-tenant CRM sistemi. 
            Mükellef yönetimi, ödeme takibi ve E-Devlet entegrasyonları ile işinizi kolaylaştırın.
          </p>
        ...
        <div className="mt-20 text-center">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 max-w-2xl mx-auto mb-8">
            <h3 className="text-lg font-semibold text-blue-900 mb-3">SMMM Demo Hesabı</h3>
            <div className="text-left space-y-2">
              <p><strong>Kullanıcı Adı:</strong> smmm1</p>
              <p><strong>Şifre:</strong> smmm123</p>
              <p className="text-sm text-blue-700 mt-3">
                Bu demo hesabı ile sistemi test edebilirsiniz. Örnek mükellef verileri ve ödeme kayıtları mevcuttur.
              </p>
            </div>
            <div className="mt-4">
              <Link 
